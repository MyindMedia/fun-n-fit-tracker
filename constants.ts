...
export const GAME_LIBRARY: GameDefinition[] = [
  ...
  },
  {
    ...
    scoringRules: 'Top 3 houses get scaled points. NFC variant: runners tap their band at the exchange — legs are clocked automatically.',
    ...
    dataCaptureFields: ['finish_time', 'nfc_split_ms'],
  ...
  { gameKey: 'BCR_01', displayName: 'Balloon Cup Race', category: 'Speed', houseTraitFocus: HouseId.SPARK, minPlayers: 2, maxPlayers: 20, recommendedAgeBand: '5-12', durationDefaultSeconds: 180, equipmentChecklist: ['Balloons', 'Red cups'], setupSteps: ['Blow cup across line with balloon air'], rules: ['Only use balloon exhaust'], scoringRules: 'First house across line wins. NFC variant: tap your band when your cup crosses — finish order and times auto-logged.', penalties: 'Blowing with mouth', tieBreaker: 'Balloon size check', safetyNotes: 'Latex allergy warning', accessibilityVariants: 'Larger target cups', coachScriptShort: 'Deflate to propel!', dataCaptureFields: ['finish_time', 'nfc_split_ms'], leaderboardMetric: 'time', templateId: 'TEMPLATE_TIME_TRIAL' },
  ...
  { gameKey: 'RIBBON_01', displayName: 'Ribbon Relay', category: 'Teamwork', houseTraitFocus: HouseId.UNITY, minPlayers: 6, maxPlayers: 40, recommendedAgeBand: '5-15', durationDefaultSeconds: 300, equipmentChecklist: ['Ribbons'], setupSteps: ['Teams tied together'], rules: ['Run together as a unit'], scoringRules: 'Points for top finish. NFC variant: any teammate taps at the line — team time recorded automatically.', penalties: 'Ribbon break', tieBreaker: 'Synchronization score', safetyNotes: 'Flat area only', accessibilityVariants: 'Elastic ribbons', coachScriptShort: 'Stay together!', dataCaptureFields: ['finish_time', 'nfc_split_ms'], leaderboardMetric: 'time', templateId: 'TEMPLATE_TIME_TRIAL' },
  ...
  { gameKey: 'ZONE_01', displayName: 'Zone Master', category: 'Agility', houseTraitFocus: HouseId.SAGE, minPlayers: 4, maxPlayers: 40, recommendedAgeBand: '5-15', durationDefaultSeconds: 300, equipmentChecklist: ['4 colored zone markers/cones', 'Whistle'], setupSteps: ['Mark 4 colored zones in the corners', 'Players start in the center'], rules: ['Coach calls a zone color — everyone sprints to it', 'Last player to arrive is out (or does 5 jumping jacks to stay in)', 'Fake calls allowed — moving on a fake means you\'re out'], scoringRules: '10 pts per round survived; last player standing +50; house with most survivors +25', penalties: 'Pushing or blocking: out for the round', tieBreaker: 'Head-to-head sprint to a called zone', safetyNotes: 'Clear paths between zones; no sliding', accessibilityVariants: 'Walk-only rounds; buddy zones', coachScriptShort: 'ZONE... BLUE! Go go go!', dataCaptureFields: ['rounds_survived', 'winner_id'], leaderboardMetric: 'score', templateId: 'TEMPLATE_REP_COUNTER' },
  { gameKey: 'TUG_01', displayName: 'Tug of War', category: 'Strength', houseTraitFocus: HouseId.VALOR, minPlayers: 6, maxPlayers: 40, recommendedAgeBand: '6-15', durationDefaultSeconds: 300, equipmentChecklist: ['Tug rope with center flag', 'Center line tape', 'Gloves (optional)'], setupSteps: ['Lay the rope across the center line', 'Even teams by size, houses face off', 'Flag starts over the center line'], rules: ['Pull on the whistle only', 'First team to drag the flag past their marker wins the round', 'Best of 3 rounds per matchup'], scoringRules: '50 pts per round won; match winners +50; every participant +10', penalties: 'Early pull: round restarts; letting go on purpose: round lost', tieBreaker: 'Single sudden-death pull, 30 seconds', safetyNotes: 'No wrapping rope around hands or body; soft ground/mats; check rope for frays', accessibilityVariants: 'Seated tug with shorter rope', coachScriptShort: 'Grip it... set... PULL!', dataCaptureFields: ['rounds_won', 'winner_house'], leaderboardMetric: 'score', templateId: 'TEMPLATE_H2H_ROUNDS' },

  // ── NFC Band games — wristband taps drive the scoring/timing ──────────────
  { gameKey: 'NFC_DASH_01', displayName: 'Band Dash Time Trial', category: 'NFC Arena', houseTraitFocus: HouseId.SPARK, minPlayers: 1, maxPlayers: 40, recommendedAgeBand: '5-15', durationDefaultSeconds: 600, equipmentChecklist: ['NFC reader at finish line', 'Cones for course'], setupSteps: ['Lay out sprint/obstacle course', 'Reader at the finish', 'Launch in NFC Bands mode — every tap is timed automatically'], rules: ['Tap your band at the start', 'Run the course', 'Tap again at the finish — the app clocks your run automatically'], scoringRules: 'Fastest split wins: 1st 50 pts, 2nd 30, 3rd 20, all finishers 10', penalties: 'Skipping obstacles: rerun', tieBreaker: 'Head-to-head rematch', safetyNotes: 'Clear landing zone around the reader', accessibilityVariants: 'Walk-pace division with own podium', coachScriptShort: 'Tap in, fly, tap out!', dataCaptureFields: ['nfc_split_ms', 'lap_count'], leaderboardMetric: 'time', templateId: 'TEMPLATE_TIME_TRIAL' },
  { gameKey: 'NFC_RELAY_01', displayName: 'Relay Rush (Band Handoff)', category: 'NFC Arena', houseTraitFocus: HouseId.UNITY, minPlayers: 6, maxPlayers: 40, recommendedAgeBand: '6-15', durationDefaultSeconds: 900, equipmentChecklist: ['NFC reader at exchange zone', 'Lane cones'], setupSteps: ['Equal house teams', 'Reader at the exchange zone', 'Launch in NFC Bands mode — taps are tracked automatically'], rules: ['Runner taps IN to start their leg', 'Next runner may only go after the incoming runner taps', 'Every leg is clocked per band automatically'], scoringRules: 'Fastest house total: 100 pts; every clean handoff 5 pts; fastest single leg 25 pts bonus', penalties: 'Early start: +5s to house total', tieBreaker: 'Captains one-lap sprint', safetyNotes: 'One runner per lane at the pad', accessibilityVariants: 'Shorter legs, same handoff', coachScriptShort: 'Tap and GO — the band is the baton!', dataCaptureFields: ['nfc_split_ms', 'handoffs'], leaderboardMetric: 'time', templateId: 'TEMPLATE_TIME_TRIAL' },
  { gameKey: 'NFC_CIRCUIT_01', displayName: 'Checkpoint Circuit', category: 'NFC Arena', houseTraitFocus: HouseId.SAGE, minPlayers: 2, maxPlayers: 30, recommendedAgeBand: '6-15', durationDefaultSeconds: 900, equipmentChecklist: ['NFC reader as checkpoint', 'Circuit stations (jump rope, hoops, wall-sit...)'], setupSteps: ['Build a loop of 3-5 exercise stations ending at the reader', 'Launch in NFC Bands mode — taps are tracked automatically'], rules: ['Complete the full station loop, then tap', 'Every tap = one circuit logged with your lap time', 'Best lap counts — pace yourself or sprint, your call'], scoringRules: 'Most circuits: 50 pts; best single lap: 30 pts; every circuit 5 pts', penalties: 'Skipped station: lap voided', tieBreaker: 'One final all-out lap', safetyNotes: 'Space stations to avoid crossing paths', accessibilityVariants: 'Adapted stations, same circuit', coachScriptShort: 'Loop it, tap it, beat your lap!', dataCaptureFields: ['nfc_split_ms', 'lap_count'], leaderboardMetric: 'time', templateId: 'TEMPLATE_TIME_TRIAL' },
  { gameKey: 'NFC_GOLD_01', displayName: 'Gold Rush Tap Race', category: 'NFC Arena', houseTraitFocus: HouseId.VALOR, minPlayers: 4, maxPlayers: 50, recommendedAgeBand: '5-15', durationDefaultSeconds: 300, equipmentChecklist: ['NFC reader mid-court', 'Task cards or exercise dice'], setupSteps: ['Reader in the middle, kids around the edge', 'Launch in NFC Bands mode — every tap banks points automatically', 'Draw a task: 5 jumping jacks, bear crawl, etc.'], rules: ['Finish the task, race to the pad, tap your band', 'Every tap banks the bounty instantly to YOUR points', 'New task every round, bounty can grow each round'], scoringRules: '+10 banked automatically per tap; final round double', penalties: 'Tapping before finishing the task: skip a round', tieBreaker: 'Sudden-death task', safetyNotes: 'Approach the pad one at a time', accessibilityVariants: 'Task menu per ability', coachScriptShort: 'Do the work, tap the gold!', dataCaptureFields: ['nfc_taps', 'points_banked'], leaderboardMetric: 'score', templateId: 'TEMPLATE_REP_COUNTER' },
