...
export const GAME_LIBRARY: GameDefinition[] = [
  ...
  },
  {
    ...
    scoringRules: 'Top 3 houses get scaled points. NFC variant: runners tap their band at the exchange — legs are clocked automatically (Timing mode).',
